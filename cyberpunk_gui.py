        ...
        for row in range(8):
            ...
            for col in range(8):
                ...
                btn = tk.Button(
                    ...
                    width=3,
                    height=1,
                    bg=self.COLORS['board_light'] if is_light else self.COLORS['board_dark'],
                    fg=self.COLORS['neon_cyan'],
    ...
    def _update_board(self):
        ...
        for square in chess.SQUARES:
            ...
            if piece:
                ...
                btn.config(fg=self.COLORS['neon_cyan'] if piece.color == chess.WHITE else self.COLORS['neon_magenta'])
            else:
                btn.config(text='')
            ...
            default_bg = self.COLORS['board_light'] if is_light else self.COLORS['board_dark']
    ...
    def _update_info(self):
        ...
        if self.board.is_checkmate():
            ...
            self.info_labels['status'].config(
                text=f"STATUS: Checkmate! {winner} wins!",
